...
import { resolveProfilesFor, getSupportedLanguages, getSupportedTypes } from '../lib/profile-map.mjs';
...
describe('profile-map', () => {
    describe('resolveProfilesFor', () => {
        ...
        it('returns common + node-library + node-service for node/service', () => {
            assert.deepEqual(resolveProfilesFor('node', 'service'), ['common', 'node-library', 'node-service']);
        });
